...
configfs_attribute!(
    ...
    store: |this,page| {
        ...
        set_zone_condition(this, sector, |zone_options, storage, mut zone| {
            zone_options.offline_zone(storage, &mut zone)
        })?;
        Ok(())
    },
);
...
configfs_attribute!(
    ...
    store: |this,page| {
        ...
        set_zone_condition(this, sector, |zone_options, storage, mut zone| {
            zone_options.read_only_zone(storage, &mut zone)
        })?;
